...
export default function AboutPage() {
  ...
  return <main className="about-page">
    ...
    <section className="about-practice-focus" id="focus">
      <div className="shell"><div className="practice-focus-list"><div><strong>01</strong><p>Business law</p></div><div><strong>02</strong><p>Regulatory practice</p></div><div><strong>03</strong><p>Corporate governance</p></div></div><a className="button button-light" href="/#expertise">Explore practice areas <ArrowDownRight size={17} /></a></div>
    </section>
